...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className="min-h-screen flex flex-col bg-[#080506] text-[#fcebed]">
        <CartProvider>
          <Navbar />
          ...
          <footer className="bg-[#080506] border-t border-[#25181b] pt-16 pb-12 text-stone-400">
            <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10">
              ...
              <div>
                ...
                <a
                  ...
                  className="w-9 h-9 rounded-full border border-[#2e1d21] flex items-center justify-center text-stone-400 hover:text-white hover:border-rose-500/50 transition-colors"
                >
              ...
              <div>
                ...
                <div className="p-3 rounded-lg border border-[#382328] bg-[#140b0d] text-xs text-rose-200/90 leading-relaxed">
            ...
            <div className="max-w-7xl mx-auto px-6 mt-12 pt-6 border-t border-[#1f1416] flex flex-col sm:flex-row items-center justify-between text-xs text-stone-500 gap-4">
